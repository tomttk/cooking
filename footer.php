...
<body>
    <footer>
        <br>
        <div class="container" style="background-color: #E6E2AF;">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                <h6><strong>Plan du Site</strong></h6>
                    <ul>
                        <li><a href="recettes.php" class="nav-link">Recettes</a></li>
                        <li><a href="viande.php" class="nav-link">Viande</a></li>
                        <li><a href="legume.php" class="nav-link">Légume</a></li>
                        <li><a href="poisson.php" class="nav-link">Poisson</a></li>
                        <li><a href="fruit.php" class="nav-link">Fruit</a></li>
